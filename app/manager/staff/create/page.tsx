...
export default function CreateUserPage() {
  ...
  const needsManagerSelection =
    role === "admin" && !!selectedRole && selectedRole !== "manager";
      ...
      <div className="w-full max-w-lg rounded-xl border border-zinc-800 bg-zinc-900 shadow-2xl">
        <div className="flex flex-col space-y-1.5 p-6 pb-4">
          ...
          <p className="text-sm text-zinc-400 mt-1.5">
            Add a new employee to your organization. Logged in as{" "}
            <span className="font-medium text-blue-400 capitalize">{role}</span>
            .
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {needsManagerSelection && (
              <div className="space-y-2 animate-in fade-in slide-in-from-top-2 duration-300">
                <label className="text-sm font-medium leading-none text-blue-400">
                  Assign to Manager (Restaurant)
                </label>
                <div className="relative">
            ...
            <button
              type="submit"
              disabled={
                isSubmitting || (needsManagerSelection && managers.length === 0)
              }
